...
import { searchTask, deleteTask } from 'common/actions/task'
									...
									<Table.Row key={'task_' + idx}>
										...
										<Table.Cell>
											...
											<ConfirmationDialog
												title={'Delete Task'}
												content={
													'Are you sure you want to delete Task with Id ' +
                          task['_id'] +
                          ' and title ' +
                          task['title']
												}
												triggerButtonContent={<Icon name="trash" />}
												okFunction={() => deleteEntity(task)}
											/>
										</Table.Cell>
									</Table.Row>
								)
...
export default reduxForm({ form: 'TASK_SEARCH_FORM' })(
	compose(withConnect)(TaskSearch)
)
