...
import { getDepartment as getDepartmentSaga } from './saga'
...
const withSaga = injectSaga({ key: 'getDepartment', saga: getDepartmentSaga })

export default compose(withSaga, withConnect)(DepartmentView)
