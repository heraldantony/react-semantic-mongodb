...
import { searchRegion as searchRegionSaga } from './saga'
...
const withSaga = injectSaga({ key: 'searchRegion', saga: searchRegionSaga })

export default reduxForm({ form: 'REGION_SEARCH_FORM' })(
	compose(withSaga, withConnect)(RegionSearch)
)
