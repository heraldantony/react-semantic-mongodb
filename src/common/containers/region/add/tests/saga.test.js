...
import { doAddRegion, addRegion } from "../saga";
...
describe("doAddRegion Saga", () => {
  ...
  it("should add Region", () => {
    ...
    let fakeResult = {
      ok: true,
      data: { _id: "f63d795a-78e7-4355-8975-40d7fdf514a1", ...fakeRegion }
    };
...
*/
  it("should handle reducer and store state", () => {
    ...
    let fakeResult = {
      ok: true,
      data: { _id: "42d1eb6d-cf2f-4d31-bbd1-7eff811f4712", ...fakeRegion }
    };
    let finalState = {
      ...initialState,
