...
import { searchEmployee, deleteEmployee } from 'common/actions/employee'
					...
					<Table celled>
						...
						<Table.Body>
                          ...
                          employee['lastName']
												...
												okFunction={() => deleteEntity(employee)}
											/>
										</Table.Cell>
									</Table.Row>
								)
...
const mapDispatchToProps = dispatch => ({
	...
	deleteEntity (employee) {
		...
		return dispatch(deleteEmployee(employee._id))
	}
})
const withConnect = connect(mapStateToProps, mapDispatchToProps)

export default reduxForm({ form: 'EMPLOYEE_SEARCH_FORM' })(
	compose(withConnect)(EmployeeSearch)
)
