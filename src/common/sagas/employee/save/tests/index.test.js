...
describe("doSaveEmployee Saga", () => {
  ...
  it("should save Employee", () => {
    ...
    fakeEmployee["firstName"] = "Alec";

    fakeEmployee["lastName"] = "Zieme";

    fakeEmployee["email"] = "Oral.Schroeder@yahoo.com";

    fakeEmployee["phoneNumber"] = "459.478.8113";

    fakeEmployee["hireDate"] =
      "Mon Jun 19 2017 08:56:23 GMT+0530 (India Standard Time)";

    fakeEmployee["salary"] = 81172;

    fakeEmployee["commissionPct"] = 66539;
...
*/
  it("should handle reducer and store state", () => {
    ...
    fakeEmployee["firstName"] = "Dovie";

    fakeEmployee["lastName"] = "Botsford";

    fakeEmployee["email"] = "Samson65@gmail.com";

    fakeEmployee["phoneNumber"] = "915.851.3847";

    fakeEmployee["hireDate"] =
      "Tue Apr 10 2018 22:55:20 GMT+0530 (India Standard Time)";

    fakeEmployee["salary"] = 84695;

    fakeEmployee["commissionPct"] = 18229;
