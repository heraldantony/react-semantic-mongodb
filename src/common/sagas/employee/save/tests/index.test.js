...
describe("doSaveEmployee Saga", () => {
  ...
  it("should save Employee", () => {
    ...
    fakeEmployee["firstName"] = "Brandi";

    fakeEmployee["lastName"] = "Ernser";

    fakeEmployee["email"] = "Zoila_Stokes@yahoo.com";

    fakeEmployee["phoneNumber"] = "669-272-4504 x0760";

    fakeEmployee["hireDate"] =
      "Wed Dec 13 2017 16:26:34 GMT+0530 (India Standard Time)";

    fakeEmployee["salary"] = 65962;

    fakeEmployee["commissionPct"] = 90720;
...
*/
  it("should handle reducer and store state", () => {
    ...
    fakeEmployee["firstName"] = "Maya";

    fakeEmployee["lastName"] = "Bednar";

    fakeEmployee["email"] = "Cassie.Goldner@yahoo.com";

    fakeEmployee["phoneNumber"] = "1-970-071-3725 x1278";

    fakeEmployee["hireDate"] =
      "Fri Mar 09 2018 09:57:19 GMT+0530 (India Standard Time)";

    fakeEmployee["salary"] = 51990;

    fakeEmployee["commissionPct"] = 65829;
