...
describe("doAddDepartment Saga", () => {
  ...
  it("should add Department", () => {
    ...
    let fakeResult = {
      ok: true,
      data: { _id: "32a940bf-1809-438f-b765-96f8a24e748a", ...fakeDepartment }
    };
...
*/
  it("should handle reducer and store state", () => {
    ...
    let fakeResult = {
      ok: true,
      data: { _id: "07d9fa89-1f89-4bec-aec2-07447d021e2c", ...fakeDepartment }
    };
    let finalState = {
      ...initialState,
