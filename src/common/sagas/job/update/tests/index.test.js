...
describe("doUpdateJob Saga", () => {
  ...
  it("should update Job", () => {
    ...
    fakeJob["jobTitle"] = "Direct Applications Supervisor";

    fakeJob["minSalary"] = 55500;

    fakeJob["maxSalary"] = 83266;
...
*/
  it("should handle reducer and store state", () => {
    ...
    fakeJob["jobTitle"] = "Human Operations Agent";

    fakeJob["minSalary"] = 38373;

    fakeJob["maxSalary"] = 34749;
