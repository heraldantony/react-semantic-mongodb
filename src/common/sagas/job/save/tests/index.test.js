...
describe("doSaveJob Saga", () => {
  ...
  it("should save Job", () => {
    ...
    fakeJob["jobTitle"] = "Principal Factors Liaison";

    fakeJob["minSalary"] = 62760;

    fakeJob["maxSalary"] = 40502;
...
*/
  it("should handle reducer and store state", () => {
    ...
    fakeJob["jobTitle"] = "Lead Intranet Coordinator";

    fakeJob["minSalary"] = 77413;

    fakeJob["maxSalary"] = 49700;
